...
public class PlanServiceImpl implements PlanService {
	...
	public ByteArrayInputStream createPdf() {
		List<PlanMasterEntity> plans = pmRepo.findAll();
		List<PlanCategoryEntity> categories = pcRepo.findAll();
		ByteArrayInputStream createPdf = PdfUtils.createPdf(plans,categories);
		return createPdf;
	}
