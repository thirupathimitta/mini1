...
import com.project.properties.PlanProperties;
...
public class PlanController {
	...
	public PlanController(PlanService planService,PlanProperties props) {
		this.planService =planService;
		this.msgs =props.getMessages();
		System.out.println(" messages are here ------>" +msgs);
	}
	...
	public ResponseEntity<InputStreamResource> createPdf() {
	    ByteArrayInputStream pdf = planService.createPdf();
